...
Public Class rptStamping1
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Product_Management_System.rptStamping1.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptStamping1
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptStamping1 = New rptStamping1()
        rpt.Site = Me.Site
        Return rpt
    End Function
