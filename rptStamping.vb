...
Public Class rptStamping
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Product_Management_System.rptStamping.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptStamping
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptStamping = New rptStamping()
        rpt.Site = Me.Site
        Return rpt
    End Function
