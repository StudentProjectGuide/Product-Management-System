...
Public Class rptCopperWire
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Product_Management_System.rptCopperWire.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptCopperWire
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptCopperWire = New rptCopperWire()
        rpt.Site = Me.Site
        Return rpt
    End Function
