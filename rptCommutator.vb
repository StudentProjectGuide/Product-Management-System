...
Public Class rptCommutator
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Product_Management_System.rptCommutator.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptCommutator
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptCommutator = New rptCommutator()
        rpt.Site = Me.Site
        Return rpt
    End Function
