...
Public Class rptCommutator1
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Product_Management_System.rptCommutator1.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptCommutator1
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptCommutator1 = New rptCommutator1()
        rpt.Site = Me.Site
        Return rpt
    End Function
